...
# PETAL
## Bayesian & Fisher Based
_C.OPTIM.SPW = 1e-8  # swag_posterior_weight
_C.OPTIM.PERC = 0.03  # percentile
## DINO Augmentation Weight
_C.OPTIM.AWT = 0.25
...
def load_cfg_fom_args(description="Config options."):
    ...
    parser.add_argument("--cfg", dest="cfg_file", type=str, 
                        # required=True,
                        default="cfgs/cifar10/vcotta.yaml",
